...
BufferSize = 80000   # Buffer size is 80000 bytes
o = 0
BufferOccupancy = []
...
while k < 9:
    ...
    def fifo_selection(w_list, max_capacity):
        selected_indices = []
        current_weight = 0
    ...
    x = fifo_selection(w_less_than_or_equal_to_26, m1)
    print('Packets put into this RU (FIFO)：', x)
    if x:
        numberofusedRU += 1
